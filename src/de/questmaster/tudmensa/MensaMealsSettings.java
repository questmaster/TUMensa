...
public class MensaMealsSettings extends PreferenceActivity {
	...
	// ----------------------------------------------------------------------------
	{
		...
		// PreferenceCategory dialogBasedPrefCat = new PreferenceCategory
		// (this);
		...
		// editTextPref.setDialogTitle
		// (R.string.dialog_title_edittext_preference);
		...
		//
		// // The Preferences screenPref serves as a screen break (similar to
		// page
		// // break in word processing). Like for other preference types, we
		// assign a
		// // key here so that it is able to save and restore its instance
		// state.
		// // Screen preference
		...
		//
		// // You can add more preferences to screenPref that will be shown on
		// the next
		// // screen.
		// // Example of next screen toggle preference
		// CheckBoxPreference nextScreenCheckBoxPref = new CheckBoxPreference
		// (this);
		// nextScreenCheckBoxPref.setKey ("next_screen_toggle_preference");
		// nextScreenCheckBoxPref.setTitle
		// (R.string.title_next_screen_toggle_preference);
		// nextScreenCheckBoxPref.setSummary
		// (R.string.summary_next_screen_toggle_preference);
		// screenPref.addPreference (nextScreenCheckBoxPref);
		//
		// // Intent preference
		// PreferenceScreen intentPref = getPreferenceManager
		// ().createPreferenceScreen (this);
		// intentPref.setIntent (new Intent ().setAction
		// (Intent.ACTION_VIEW).setData (Uri.parse ("http://www.android.com")));
		...
		// CheckBoxPreference parentCheckBoxPref = new CheckBoxPreference
		// (this);
		//
		...
		// childCheckBoxPref.setLayoutResource (a.getResourceId
		// (R.styleable.TogglePrefAttrs_android_preferenceLayoutChild, 0));
	...
	// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	{
		...
		// ----------------------------------------------------------------------------
		{
			...
			if (sharedPref != null) {
				...
				// m_bExpandAll = sharedPref.getBoolean
				// (MensaMealsSettings.__PREF_KEY_EXPAND_ALL, m_bExpandAll);
				// m_bShowCreatedTime = sharedPref.getBoolean
				// (MensaMealsSettings.__PREF_KEY_SHOW_CREATED,
				// m_bShowCreatedTime);
				...
				// m_sTimeFormat = sharedPref.getString
				// (MensaMealsSettings.__PREF_KEY_TIME_FORMAT,
				// __TIME_FORMAT_DEFAULT);
			}
		}
	}
}
